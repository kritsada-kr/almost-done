...
@section('content')
    <article class="mx-8">
        <div class="shadow-lg rounded-lg overflow-hidden pt-5">
            <h1 class="text-3xl mb-1 break-words p-5">
                {{ $post->title }}
            </h1>
            ...
            <p class="text-gray-900 font-normal pl-5 mb-8 break-words">
                {{ $post->description }}
            </p>
            <div>
...
{{--            @if($likeStatus)--}}
{{--                <form action="{{ route('posts.likes.like',['post' => $post->id]) }}" method="post">--}}
{{--                    @csrf--}}
{{--                    <div class="my-4">--}}
{{--                        <button class="app-button red" type="submit"> Unlike </button>--}}
{{--                    </div>--}}
{{--                </form>--}}
{{--            @else--}}
                <form action="{{ route('posts.likes.like',['post' => $post->id]) }}" method="post">
                    @csrf
                    <div class="my-4">
                        <button class="app-button red" type="submit"> Like </button>
                    </div>
                </form>
{{--            @endif--}}
        </div>
